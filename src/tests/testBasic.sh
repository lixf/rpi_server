...
CLIENT_IP=unix3.andrew.cmu.edu
...
CLIENT_GO=$PROJECT_PATH/src/runners/crunner/crunner.go
LOGS=/afs/andrew.cmu.edu/usr23/smklein/private/15418/rpi_server/src/tests/logs
TESTS=/afs/andrew.cmu.edu/usr23/smklein/private/15418/rpi_server/src/tests
...
echo "CLIENT:"
ssh -T $USERNAME@$CLIENT_IP "go run $CLIENT_GO -b=$TESTS/basicGetPost.txt > $LOGS/client.log &" < /dev/null
...
scp $USERNAME@$CLIENT_IP:$LOGS/client.log logs/client.log
